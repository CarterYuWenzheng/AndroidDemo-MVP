...
public class WxArticleListAdapter extends BaseQuickAdapter<ArticleItemBean, BaseViewHolder> {

    public WxArticleListAdapter(int layoutResId, @Nullable List<ArticleItemBean> data) {
